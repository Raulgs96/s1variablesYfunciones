 ...
 ** 4.- Necesito una lista que contenga a todos los usuarios, pero con las siguientes propiedades:
  ...
  */
  ...
  //1.- Necesito obtener una lista de aquellos usuarios que tengan cierta nacionalidad 
  /*const getNat = (usersArray, natToSearch) => {
    let nat = usersArray.filter((user) =>
      user.nat === natToSearch
        ? console.log(`Si existe ${natToSearch}`)
        : console.log("No existe el usuario con esa nacionalidad")
    );
